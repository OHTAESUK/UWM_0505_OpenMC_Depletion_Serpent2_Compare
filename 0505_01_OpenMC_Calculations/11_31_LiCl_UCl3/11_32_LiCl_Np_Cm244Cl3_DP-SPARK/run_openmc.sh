#!/bin/bash
#SBATCH -J LiCl_Np_Cm244Cl3
#SBATCH -o slurm_%j.out
#SBATCH -e slurm_%j.err
#SBATCH -N 5                   # NUMBER OF PHYSICAL NODES
#SBATCH --ntasks=10            # MPI ranks Ex) --ntasks=64       | THIS INDICATES        |
...
# ===========================================
WORKDIR=/home/toh8/OpenMC/Calculation/OPT05_DEPLETION_FP_REMOVAL/11_LiCl_AnCl3/11_31_LiCl_UCl3/11_32_LiCl_Np_Cm244Cl3_DP-SPARK
...
srun apptainer exec \
     ...
     python3 -u LiCl_Np_Cm244Cl3_DP_SPARK.py
