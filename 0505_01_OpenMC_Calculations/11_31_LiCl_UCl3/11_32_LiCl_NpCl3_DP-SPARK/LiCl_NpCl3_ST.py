...
# ============================================================
# 1) Material: ALL Np237 (for testing) Cl-35 5 a/o
# ============================================================

materials = openmc.Materials()

fuel = openmc.Material(name="LiCl_NpCl3")
...
fuel.add_nuclide("Np237", 11.53846153846, "ao")
...
print("[OK] Infinite LiCl-NpCl3 steady-state OpenMC input written.")
