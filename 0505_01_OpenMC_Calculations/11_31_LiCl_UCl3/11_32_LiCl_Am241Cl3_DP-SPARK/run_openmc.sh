#!/bin/bash
#SBATCH -J LiCl_Am241Cl3
#SBATCH -o slurm_%j.out
#SBATCH -e slurm_%j.err
#SBATCH -N 1                   # NUMBER OF PHYSICAL NODES
#SBATCH --ntasks=2             # MPI ranks Ex) --ntasks=64       | THIS INDICATES        |
#SBATCH --cpus-per-task=32     # OpenMP        --cpus-per-task=1 | MPI = 64 / OpenMP = 1 |
#SBATCH -t 72:00:00
#SBATCH -p shared
...
# ===========================================
WORKDIR=/home/toh8/OpenMC/Calculation/OPT05_DEPLETION_FP_REMOVAL/11_LiCl_AnCl3/11_31_LiCl_UCl3/11_32_LiCl_Am241Cl3_DP-SPARK
...
srun apptainer exec \
     ...
     python3 -u LiCl_Am241Cl3_DP_SPARK.py
