...
#SBATCH -N 12                   # NUMBER OF PHYSICAL NODES
#SBATCH --ntasks=12             # MPI ranks Ex) --ntasks=64       | THIS INDICATES        |
#SBATCH --cpus-per-task=40      # OpenMP        --cpus-per-task=1 | MPI = 64 / OpenMP = 1 |
#SBATCH -t 24:00:00
#SBATCH -p pre
...
# ===========================================
WORKDIR=/home/toh8/OpenMC/Calculation/OPT05_DEPLETION_FP_REMOVAL/91_NaCl_UCl3/91_02_NaCl_UCl3_DP_URR_OFF_REMOVAL
...
srun apptainer exec \
     ...
     python3 -u OpenMC_Depletion_Removal.py
